<x-app-layout title="{{Auth::user()->nickname}}">
        ...
        <div class="relative  max-w-md mx-auto mt-20 ">
            <div class="rounded overflow-hidden shadow-md bg-white">
                <div class="absolute -mt-16 w-full flex justify-center">
                    <div class="h-32 w-32 ">
                        <img src="{{$user->profile_photo_url}}" alt="{{$user->nickname}}" class="rounded-full object-cover h-full w-full shadow-md border-2 border-emerald-300" />
                    </div>
                </div>
                <div class="px-6 mt-16">
                    ...
                    <h2 class="font-bold text-2xlxl text-center mb-1">
                       {{'@'.$user->nickname}}
                    </h2>
                    {{-- <p class="text-gray-800 text-sm text-center">Chief Executive Officer</p> --}}
                    <p class="text-center pb-4 text-gray-600 text-base pt-3 font-normal">
                        {{$user->bio ? $user->bio : 'Sin Info'}}
